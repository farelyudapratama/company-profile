<x-layout>
    ...
    <div class="p-4 md:p-8 bg-gray-50 rounded-lg">
        ...
        <h3 class="text-xl md:text-2xl font-bold text-gray-800 text-center mt-12 mb-6">Apa Kata Mereka? 💬</h3>
        <div class="flex flex-col items-center space-y-4 mb-8">
            <blockquote class="bg-gray-100 rounded-lg p-4 shadow-md max-w-md text-center">
