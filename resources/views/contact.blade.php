<x-layout>
    ...
    <div class="max-w-6xl mx-auto px-4 py-12">
        <div class="text-center mb-16">
            <span class="bg-blue-100 text-blue-800 text-sm font-medium px-4 py-1.5 rounded-full">Hubungi Kami!</span>
            <h2
                ...
                Yuk Wujudkan Ide Keren Kamu
            </h2>
            <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                Kami siap bantu kamu mengubah visi jadi solusi digital yang keren abis.
                Tim ahli kami bakal guide kamu di setiap tahap pengembangan.
            </p>
        </div>
        ...
        <div class="grid lg:grid-cols-3 gap-8 mb-16">
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                ...
                <h3 class="text-xl font-semibold mb-2">Channel Komunikasi</h3>
                <div class="space-y-2 text-gray-600">
                ...
                <div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div
                            ...
                            <div>
                                <h3 class="text-lg font-semibold text-gray-900">Kantor Kami</h3>
                                <p class="mt-1 text-gray-600">Jl. Berlian 306, Vila Mas Garden, Kota Bekasi</p>
                                <a href="#" class="text-blue-600 hover:text-blue-700 mt-2 inline-block">Lihat di
                                    Google Maps →</a>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 mt-1">Tersedia layanan WhatsApp Business</p>
                                <a href="https://wa.me/6289613240824"
                                    class="text-blue-600 hover:text-blue-700 mt-2 inline-block">Chat WhatsApp →</a>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 mt-1">Respon dalam 24 jam kerja</p>
                                <a href="mailto:sigmasatein@gmail.com"
                                    class="text-blue-600 hover:text-blue-700 mt-2 inline-block">Kirim Email →</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="mt-16 text-center bg-gradient-to-r from-blue-600 via-purple-600 to-red-500 rounded-2xl p-8 md:p-12">
            <h3 class="text-2xl md:text-3xl font-bold text-white mb-4">Siap Memulai Project?</h3>
            <p class="text-white/90 mb-6 max-w-2xl mx-auto">
                Tim kami siap bantu wujudkan ide kamu jadi solusi digital yang keren. Hubungi kami sekarang untuk
                konsultasi gratis!
            </p>
            <a href="https://wa.me/6289613240824"
